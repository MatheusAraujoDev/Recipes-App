...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-011-project-recipes-app/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-011-project-recipes-app/pulls) e confira que o seu _Pull Request_ está criado
...
Para rodar somente um arquivo de teste, você precisa utilizar o comando `npm run cy -- --spec cypress/integration/login_spec.js`, sendo que após o "spec" é preciso acrescentar todo o caminho até o arquivo de testes.
